...
class App {
    public static void main(final String[] args) {
        ...
        float longitude, ancho, cost_met,costo_terr ; 
        // El objeto
        ...
        try {
            ...
            costo_terr = obj.calcularTerrenos();
            // presntamos el resultado del costo de un terreno
            System.out.println("El costo de un terreno es : " + costo_terr+" Balboa");
        } 
        catch (IOException e) {
